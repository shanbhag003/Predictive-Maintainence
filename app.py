...
def predict_results(final_df):
    final_df = final_df.drop(['REGION_CLUSTER', 'MAINTENANCE_VENDOR', 'MANUFACTURER', 'WELL_GROUP', 'EQUIPMENT_FAILURE'],
                       axis=1)
    ...
    result = pd.concat([X,prediction],axis=1)
